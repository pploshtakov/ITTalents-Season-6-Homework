...
public class GameDemo {
	...
	private static void warGame(Player p1, Player p2) throws InterruptedException {
	...
	private static void war(Player p1, Player p2, Card p1Card, Card p2Card) throws InterruptedException {
	...
	private static int compareCards(Card p1Card, Card p2Card, Player p1, Player p2) throws InterruptedException {
